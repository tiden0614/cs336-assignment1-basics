...
def run_linear(
    ...
    linear_module = lego.LinearModule(d_in, d_out)
...
def run_multihead_self_attention(
    ...
    """
    mha_module = lego.MultiHeadSelfAttentionModule(d_model, num_heads)
    mha_module.load_weights(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight)
    return mha_module.forward(in_features)
...
def run_transformer_block(
    ...
    """
    transformer_block = lego.TransformerBlock(
        d_model=d_model,
        num_heads=num_heads,
        d_ff=d_ff,
    ...
    transformer_block.load_weights(
...
def run_rmsnorm(
    ...
    """
    rmsnorm_module = lego.RMSNormModule(d_model, eps)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return lego.softmax(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    return lego.cross_entropy(inputs, targets)
...
def run_gradient_clipping(
    ...
    """
    return lego.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return lego.cosine_annealing_learning_rate_schedule(
        t=it,
...
def get_tokenizer(
    ...
    """
    return bpe_tok.Tokenizer(vocab, merges, special_tokens)
